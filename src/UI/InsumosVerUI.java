...
public class InsumosVerUI extends javax.swing.JInternalFrame {
    ...
    public InsumosVerUI() {
        initComponents();
        controlInsumos = new ControlInsumos();
        insumosTable.getTableHeader().setFont(new Font("SansSerif", Font.PLAIN, 12));
        insumosTable.getTableHeader().setOpaque(false);
        insumosTable.getTableHeader().setBackground(Color.white);
...
//        d.addActionListener(new verListener());
    ...
    private void initComponents() {
        ...
        insumosTable.setFont(new java.awt.Font("SansSerif", 0, 10)); // NOI18N
        ...
        insumosTable.setGridColor(new java.awt.Color(255, 255, 255));
        insumosTable.setSelectionBackground(new java.awt.Color(133, 198, 90));
        insumosTable.getTableHeader().setReorderingAllowed(false);
        ...
        jLabel17.setText("Insumos Registrados");
    ...
    public class InsumosTableModel implements TableModel {
        ...
        private String[] nombreColumnas = {"Nombre", "Descripción"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            Insumo insumo = controlInsumos.getListaInsumos().get(rowIndex);
            switch (columnIndex) {
                case 0:
