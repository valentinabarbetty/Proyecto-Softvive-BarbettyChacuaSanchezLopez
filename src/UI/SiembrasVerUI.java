...
public class SiembrasVerUI extends javax.swing.JInternalFrame {

    ControlSiembra controlSiembra;

    public SiembrasVerUI() {
        initComponents();
        controlSiembra = new ControlSiembra();
        System.out.println(controlSiembra.getListaSiembras());
...
//        this.getContentPane().setBackground(Color.white);
    ...
    private void initComponents() {
        ...
        siembraTable.setFont(new java.awt.Font("SansSerif", 0, 10)); // NOI18N
        ...
        siembraTable.setGridColor(new java.awt.Color(255, 255, 255));
        siembraTable.setSelectionBackground(new java.awt.Color(133, 198, 90));
        siembraTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane3.setViewportView(siembraTable);
    ...
    public class SiembrasTableModel implements TableModel {
        ...
        private String[] nombreColumnas = {"Codigo", "Fecha", "Planta", "Cantidad", "Muertes", "Estado siembra"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 2:
                    return siembra.getPlanta();
                case 3:
                    return siembra.getCantidad();
                case 4:
                    return siembra.getMuertes();
                case 5:
