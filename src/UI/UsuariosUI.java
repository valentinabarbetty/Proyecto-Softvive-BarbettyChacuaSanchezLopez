...
public class UsuariosUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        AddUser.setText("Agregar Usuario Nuevo");
        ...
        EditUser.setText("Editar Usuarios");

        jPanel2.setBackground(new java.awt.Color(108, 169, 62));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/usuario.png"))); // NOI18N
    ...
    public class clickAddListener implements MouseListener {
        ...
        private UsuariosAddUI usuariosAddUI;

        @Override
        public void mouseClicked(MouseEvent e) {

            if (usuariosAddUI == null) {
                usuariosAddUI = new UsuariosAddUI();
    ...
    public class clickSeeListener implements MouseListener {
        ...
        private UsuariosSeeUI usuariosSeeUI;

        @Override
        public void mouseClicked(MouseEvent e) {

            if (usuariosSeeUI == null) {
                usuariosSeeUI = new UsuariosSeeUI();
