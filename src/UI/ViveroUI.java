...
//        this.editarInsumos.addActionListener(new InventarioInsumosListener());
    ...
    private void initComponents() {
        ...
        pedidos1.setText("Gestionar Pedidos");

        pedidos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/cart.png"))); // NOI18N
        ...
        getContentPane().add(desktop, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1550, 780));
